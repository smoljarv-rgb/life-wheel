...
function fixUkrainianText(text){
  ...
  const fixes=[
    // --- відчуваєте відчуття: специфічні форми з правильними відмінками ---
    [/відчуваєте\s+відчуття\s+тривог[иіу]?\b/gi,'відчуваєте тривогу'],
    [/відчуваєте\s+відчуття\s+провин[иіу]?\b/gi,'відчуваєте провину'],
    [/відчуваєте\s+відчуття\s+вин[иі]\b/gi,'відчуваєте провину'],
    [/відчуваєте\s+відчуття\s+самотност[іи]?\b/gi,'почуваєтесь самотньо'],
    [/відчуваєте\s+відчуття\s+ізольованост[іи]?\b/gi,'почуваєтесь ізольовано'],
    [/відчуваєте\s+відчуття\s+страх[уа]?\b/gi,'відчуваєте страх'],
    [/відчуваєте\s+відчуття\s+порожнеч[іиу]?\b/gi,'відчуваєте порожнечу'],
    [/відчуваєте\s+відчуття\s+напруг[иіу]?\b/gi,'відчуваєте напругу'],
    [/відчуваєте\s+відчуття\s+стрес[уа]?\b/gi,'відчуваєте стрес'],
    [/відчуваєте\s+відчуття\s+безпорадност[іи]?\b/gi,'відчуваєте безпорадність'],
    [/відчуваєте\s+відчуття\s+невпевненост[іи]?\b/gi,'почуваєтесь невпевнено'],
    [/відчуваєте\s+відчуття\s+безнадійност[іи]?\b/gi,'відчуваєте безнадію'],
    [/відчуваєте\s+відчуття\s+розчаруванн[яіє]?\b/gi,'розчаровані'],
    [/відчуваєте\s+відчуття\s+провал[уює]?\b/gi,'боїтесь провалу'],
    [/відчуваєте\s+відчуття\s+відчуженост[іи]?\b/gi,'почуваєтесь відчужено'],
    // --- catch-all: прибираємо "відчуття" зі середини ---
    [/відчуваєте\s+відчуття\s+/gi,'відчуваєте '],
    [/відчуваєте\s+відчуття\b/gi,'відчуваєте'],
    // --- та ж логіка для відчуваєш / відчуває (якщо трансформація на "Ви" ще не пройшла) ---
    [/відчуваєш\s+відчуття\s+/gi,'відчуваєш '],
    [/відчуваєш\s+відчуття\b/gi,'відчуваєш'],
    [/відчуває\s+відчуття\s+/gi,'відчуває '],
    [/відчуває\s+відчуття\b/gi,'відчуває'],
    // --- інші тавтології ---
