...
app.post('/api/portrait', async (req, res) => {
  ...
  const sysPrompt = [
    ...
    '',
    'ЗАБОРОНЕНІ ТАВТОЛОГІЇ — ці фрази НІКОЛИ не використовувати:',
    '- "відчуваєте відчуття" -> замінити: "переживаєте", "відчуваєте" без другого слова, "вам тяжко", "вас охоплює"',
    '- "відчуваєте відчутну" -> замінити: "помітно", "суттєво", "явно"',
    '- "маєте наявність" -> замінити: "маєте", "у вас є"',
    '- "відсутність X" -> замінити: "Вам бракує X", "X поки немає"',
    '- "займайтесь розвитком" -> замінити: "розвивайтесь", "навчайтесь"',
    '',
    'СЛОВНИК СИНОНІМІВ — чергуй, не повторюй одне слово двічі поспіль:',
    'Замість "відчуваєте": переживаєте / помічаєте / усвідомлюєте / вас охоплює / вам здається / ви бачите / вас тисне / вам дається взнаки / ви стикаєтесь з',
    ...
    'Замість "важливо": варто / доречно / має сенс / корисно',
    '',
    'ПРАВИЛО ПЕРЕВІРКИ: перед кожним реченням запитай "чи повторюю слово з попереднього?" — якщо так, замінити синонімом.',
    '',
