...
function fixUkrainianText(text){
  ...
  const pairs=[
    ...
    ['відчуваєте відчуття тривоги','відчуваєте тривогу'],
    ['відчуваєте відчуття провини','відчуваєте провину'],
    ['відчуваєте відчуття вини','відчуваєте провину'],
    ['відчуваєте відчуття самотності','почуваєтесь самотньо'],
    ['відчуваєте відчуття ізольованості','почуваєтесь ізольовано'],
    ['відчуваєте відчуття страху','відчуваєте страх'],
    ['відчуваєте відчуття порожнечі','відчуваєте порожнечу'],
    ['відчуваєте відчуття напруги','відчуваєте напругу'],
    ['відчуваєте відчуття стресу','відчуваєте стрес'],
    ['відчуваєте відчуття безпорадності','відчуваєте безпорадність'],
    ['відчуваєте відчуття невпевненості','почуваєтесь невпевнено'],
    ['відчуваєте відчуття безнадійності','відчуваєте безнадію'],
    ['відчуваєте відчуття розчарування','розчаровані'],
    ['відчуваєте відчуття провалу','боїтесь провалу'],
    ['відчуваєте відчуття відчуженості','почуваєтесь відчужено'],
    ['відчуваєте відчуття обмеженості','відчуваєте обмеженість'],
    ['відчуваєте відчуття безвиходу','відчуваєте безвихідь'],
    ['відчуваєте відчуття нестачі','відчуваєте нестачу'],
    ['відчуваєте відчуття втрати','відчуваєте втрату'],
    ['відчуваєте відчуття сорому','соромитесь'],
    ['відчуваєте відчуття віддаленості','відчуваєте відчуженість'],
    ['відчуваєте відчуття меншовартості','почуваєтесь меншовартісно'],
    ['відчуваєте відчуття незахищеності','почуваєтесь незахищено'],
    ['відчуваєте відчуття відчаю','відчуваєте відчай'],
    ['відчуваєте відчуття незадоволеності','відчуваєте незадоволеність'],
    ...
    ['Відчуваєте відчутну','Помітно відчуваєте'],
    // відчуваєш / відчуває
    ['відчуваєш відчуття ','відчуваєш '],
    ['відчуваєш відчуття','відчуваєш'],
    ['відчуває відчуття ','відчуває '],
    ['відчуває відчуття','відчуває'],
    // "відчуття X" standalone
    ['відчуття відчуття','відчуття'],
    ['відчуття ізольованості','самотність'],
    ['відчуття порожнечі','внутрішню порожнечу'],
    ['відчуття тривоги','тривогу'],
    ['відчуття провини','провину'],
    ['відчуття страху','страх'],
    ['відчуття самотності','самотність'],
    ['відчуття незручності','незручність'],
    ['відчуття меншовартості','меншовартість'],
    ['відчуття відчаю','відчай'],
    ['тісне відчуття','гнітюче відчуття'],
    ['вас тісне','вас гнітить'],
    // робить X відчутними / відчутним
    ['робить стосунки відчутними','робить стосунки напруженими'],
    ['робить відносини відчутними','робить відносини напруженими'],
    ['робить життя відчутним','ускладнює життя'],
    // "ця людина" → "Ви"
    ['ця людина відчуває','Ви відчуваєте'],
    ['Ця людина відчуває','Ви відчуваєте'],
    ['ця людина має','Ви маєте'],
    ['Ця людина має','Ви маєте'],
    ['ця людина переживає','Ви переживаєте'],
    ['Ця людина переживає','Ви переживаєте'],
    ['ця людина','Ви'],
    ['Ця людина','Ви'],
    ['людина відчуває','Ви відчуваєте'],
    ['людина має','Ви маєте'],
    ['людина переживає','Ви переживаєте'],
    // вона/він → Ви
    ['вона відчуває','Ви відчуваєте'],
    ['він відчуває','Ви відчуваєте'],
    ['Вона відчуває','Ви відчуваєте'],
    ['Він відчуває','Ви відчуваєте'],
    // відсутність → брак
    ['відсутність мотивації','брак мотивації'],
    ['відсутність енергії','брак енергії'],
    ['відсутність підтримки','брак підтримки'],
    ['відсутність впевненості','брак впевненості'],
    ['відсутність балансу','дисбаланс'],
    ['відсутність сенсу','брак сенсу'],
    ['відсутність спілкування','брак спілкування'],
    ['відсутність задоволення','брак задоволення'],
  ...
  try {
    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: systemPrompt || "Ти — досвідчений коуч. Відповідай ТІЛЬКИ валідним JSON без markdown.\n\nМова: українська. Звернення: виключно на \"Ви\" з великої літери.\nЗАБОРОНЕНО: \"ця людина\", \"він\", \"вона\", \"людина відчуває\".\n\n=== ГРАМАТИЧНА ЗАБОРОНА #1 (КРИТИЧНО) ===\nНІКОЛИ не пиши \"відчуваєте відчуття\" — це тавтологія.\nПравило: після \"відчуваєте\" ОДРАЗУ іменник у знахідному відмінку.\n× ПОГАНО: \"відчуваєте відчуття тривоги\" / \"відчуваєте відчуття самотності\"\n✓ ДОБРЕ:  \"відчуваєте тривогу\" / \"вас охоплює самотність\"\nПеред кожним реченням: якщо бачиш \"відчуваєте відчуття\" — СТОП, переформулюй.\n\n=== ГРАМАТИЧНА ЗАБОРОНА #2 ===\n× \"відсутність X\" → ✓ \"Вам бракує X\"\n× \"займайтесь розвитком\" → ✓ \"розвивайтесь\"\n\nСЛОВНИК — чергуй:\nзамість \"відчуваєте\": переживаєте / вас охоплює / помічаєте / вам дається взнаки / вас тисне\nзамість \"проблема\": виклик / складність / больова точка\nзамість \"важливо\": варто / доречно / має сенс" },
...
app.post('/api/portrait', async (req, res) => {
  ...
  const sysPrompt = [
    'Ти — досвідчений коуч і психолог. Пишеш виключно українською.',
    'Звертаєшся до людини на "Ви" з великої літери.',
    'Ніколи не використовуєш "ця людина / він / вона".',
    '',
    '=== ГРАМАТИЧНА ЗАБОРОНА #1 (КРИТИЧНО) ===',
    'НІКОЛИ не пиши "відчуваєте відчуття" — це тавтологія.',
    'Правило: після "відчуваєте" ОДРАЗУ іменник у знахідному відмінку.',
    '× ПОГАНО: "відчуваєте відчуття тривоги" / "відчуваєте відчуття самотності" / "відчуваєте відчуття несправедливості"',
    '✓ ДОБРЕ:  "відчуваєте тривогу" / "вас охоплює самотність" / "вас гнітить несправедливість"',
    'Перед кожним реченням: якщо бачиш "відчуваєте відчуття" — СТОП, переформулюй.',
    '',
    '=== ГРАМАТИЧНА ЗАБОРОНА #2 ===',
    '× "відсутність X" → ✓ "Вам бракує X" або "X поки немає у Вашому житті"',
    '× "займайтесь розвитком" → ✓ "розвивайтесь" / "навчайтесь"',
    '× "маєте наявність" → ✓ "маєте" / "у Вас є"',
    '',
    'СЛОВНИК СИНОНІМІВ — чергуй, не повторюй одне слово двічі поспіль:',
    'замість "відчуваєте": переживаєте / вас охоплює / помічаєте / вам дається взнаки / вас тисне / усвідомлюєте',
    'замість "проблема": виклик / складність / зона росту / болюча точка / незакритий запит',
    'замість "розвиток": зростання / прогрес / рух вперед / зміни / новий рівень',
    'замість "важливо": варто / доречно / має сенс / корисно',
    '',
    'Тон — як розмова з розумним другом який дивиться в очі. Без канцеляризмів.',
    'Respond ONLY with valid JSON, no markdown.'
  ].join('\n');
  const userPrompt = [
    'Людина оцінила 12 сфер свого життя. Результати:',
    scoresList,
    '',
    weakCauses ? 'Кореневі причини по найслабших сферах:' : '',
    weakCauses || '',
    '',
    'Сформуй психологічний портрет. Звертайся на "Ви".',
    'Поверни ТІЛЬКИ валідний JSON без markdown:',
    '{',
    '  "type": "[1-3 слова. Психологічний тип. Наприклад: Трудоголік що вигорає / Прихований мрійник / Людина на паузі]",',
    '  "preview": "[Рівно 2 речення на Ви. Перше: що зараз відбувається у Вашому житті — конкретно, без узагальнень. Друге: одне несподіване спостереження яке людина впізнає як правду. Перевір: чи немає повторів слів? чи звучить природно?]",',
    '  "full_text": "[4-5 речень на Ви. Логічний зв\'язок між реченнями — кожне розвиває думку попереднього. Покажи як різні сфери впливають одна на одну. Закінчи на ноті можливості. Перевір: жодного повтору слів у сусідніх реченнях]",',
    '  "core_pattern": "[1 речення на Ви. Головна причина яка пояснює більшість низьких балів. Формулювання: Ваш головний патерн — ...]",',
    '  "growth_vector": "[1 речення на Ви. Конкретний перший крок — не розвивайтесь а що саме і коли]",',
    '  "month_plan": [',
    '    {"week":1,"focus":"[Назва фокусу]","sphere":"[Сфера]","actions":["[Конкретна дія від 2-ї особи множини: Оберіть / Зробіть / Спробуйте + що саме + коли]","[Конкретна дія]","[Конкретна дія]"]},',
    '    {"week":2,"focus":"","sphere":"","actions":["","",""]},',
    '    {"week":3,"focus":"","sphere":"","actions":["","",""]},',
    '    {"week":4,"focus":"","sphere":"","actions":["","",""]}',
    '  ]',
    '}',
    '',
    'КРИТИЧНО:',
    '- Жодного "ця людина", "вона", "він" — тільки "Ви/Вам/Вас"',
    '- Жодного "відсутність [слово]" — замінювати живою мовою',
    '- Жодних тавтологій: "відчуваєте відчуття" -> "відчуваєте", "займайтеся розвитком" -> "розвивайтеся"',
    '- preview — має зачепити за живе з першого прочитання',
    '- full_text — логічна послідовність думок, не перелік'
  ].filter(Boolean).join('\n');
      ...
      try {
        ...
        const groqRes = await fetch('https://api.groq.com/openai/v1/chat/completions', {
          ...
          body: JSON.stringify({
            model: 'llama-3.1-8b-instant',
            messages: [
              { role: 'system', content: "Ти — досвідчений коуч. Відповідай ТІЛЬКИ валідним JSON без markdown.\n\nМова: українська. Звернення: виключно на \"Ви\" з великої літери.\nЗАБОРОНЕНО: \"ця людина\", \"він\", \"вона\", \"людина відчуває\".\n\nЗАБОРОНЕНІ ТАВТОЛОГІЇ — ніколи не використовувати:\n- \"відчуваєте відчуття\" або \"відчуваєте відчутну\" -> замість: \"переживаєте\", \"вас охоплює\", \"вам тяжко\"\n- \"відчуття ізольованості\" -> замість: \"самотність\", \"відчуженість\", \"порожнеча\"\n- \"відсутність X\" -> замість: \"Вам бракує X\", \"X ще не знайшло місця у Вашому житті\"\n- \"тісне відчуття\" -> не існує по-українськи. Замість: \"тисне\", \"гнітить\", \"відчувається як тягар\"\n- Будь-яке слово \"відчуття\" або \"відчуваєте\" — НЕ повторювати двічі в одному тексті\n\nСЛОВНИК — чергуй, не повторюй одне слово двічі поспіль:\nзамість \"відчуваєте\": переживаєте / помічаєте / усвідомлюєте / вас охоплює / вам дається взнаки / гнітить / тисне\nзамість \"проблема\": виклик / складність / больова точка / незакрите питання\nзамість \"важливо\": варто / доречно / має сенс / корисно\n\nПЕРЕВІРКА перед відповіддю:\n1. Чи є слово \"відчуття\" більше одного разу? -> замінити синонімом\n2. Чи є тавтологія (однокореневі слова поруч)? -> переформулювати\n3. Чи звучить природно по-українськи вголос? -> якщо ні, спростити" },
              { role: 'user', content: prompt }
            ],
            max_tokens: 1500,
            temperature: 0.3,
