...
app.post('/api/portrait', async (req, res) => {
  ...
  const sysPrompt = [
    ...
    '',
    'Правила мови — ОБОВ\'ЯЗКОВО:',
    '1. Жодних калькованих фраз: не "відчуваєте відчуття", не "маєте наявність", не "займайтеся розвитком розвитку"',
    '2. Замість "відсутність X" -> "Вам бракує X" або "X поки немає місця"',
    '3. Замість "відчуваєте відчуття Y" -> просто "відчуваєте Y"',
    '4. Кожне речення — окрема думка, не повтор попереднього',
    '5. Без канцеляризмів. Без кліше типу "баланс та гармонія"',
    '6. Тон — як розмова з розумним другом який дивиться в очі',
    '7. Перед відправкою подумки перечитай кожне речення: чи звучить воно природно по-українськи? Якщо ні — переформулюй простіше',
    '',
